...
if __name__ == "__main__":
    ...
    hyper_parameters_patnet = {'activation_function': 'leaky_relu', 'dropout': 0.2, "batch_size": 32, 'epochs':60,
                               'hidden_sizes': 1024, 'learning_rate': 0.0001, 'optimizer': 'sgd'}
    ...
    with open('scores/MLP-KM_scores.pkl', 'wb') as pickle_file:
