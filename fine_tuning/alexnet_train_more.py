# train the alexnet a bit more, see what you get!
import torch
...
directory = "results/transfer_learning/alexnet"
    ...
    for file in files:
        ...
        if file.endswith(".pth"):
            ...
            make_cm(
                ...
                name=f"AlexNet Model: {name}",
                path=f"{root}"
            )

            plot_results(history, f"{root}", title=f"AlexNet with Additional Training")
